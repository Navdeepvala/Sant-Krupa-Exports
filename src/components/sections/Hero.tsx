          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">
                Premium Quality Manufacturing Since 2010
              </span>
            </motion.div>
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
              We export premium agricultural products such as jaggery, groundnut
              oil, ghee, honey, peanuts, fresh fruits, fresh vegetable and other
              agricultural products.all produced in our own farm and
              manufacturing facility in Gujarat, guaranteeing quality and
              authenticity
            </p>
